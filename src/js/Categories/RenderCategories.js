        ...
        this.renderAll(`
            ...
            <td class="py-8 px-6">
                <div class="flex justify-center gap-3">
                    <button class="editButton px-6 py-3 bg-[#f4f9e6] text-[#76a609] rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-[#76a609] hover:text-white transition-all" value="${this.id}">Edit</button>
                <button class="deleteButton px-6 py-3 bg-red-50 text-red-500 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all" value="${this.id}">Delete</button>
                </div>
            </td>
