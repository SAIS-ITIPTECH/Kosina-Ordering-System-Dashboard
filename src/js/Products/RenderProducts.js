    ...
    render(){
        this.renderAll(`
            ...
            <td class="py-6 px-6 text-center">
                ...
                <button onclick="openEditProduct('edit')" class="editButton text-[#76a609] font-black text-[10px] uppercase tracking-widest hover:underline" value="${this.id}">Edit</button>
            </td>
        `,);
